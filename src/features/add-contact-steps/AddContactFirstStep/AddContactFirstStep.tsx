...
import styles from "./AddContactFirstStep.module.scss";
    ...
    <section className="flex gap-12 py-12">
      <Card className="text-center border-2 border-dashed py-12 px-8 w-full relative">
        ...
        <Input
          id="picture"
          type="file"
          className={`${styles["upload-file"]} border-0 mx-auto absolute top-0 left-0 h-full w-full opacity-0 cursor-pointer`}
        />
      </Card>
